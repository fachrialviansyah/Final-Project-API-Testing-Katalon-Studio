...
def response = WS.sendRequest(findTestObject('Mock API/03 POST User', [('first_name') : 'Fachri', ('last_name') : 'Alvi', ('username') : usernameRandom , ('job_position') : 'Software Quality Assurance', ('job_level') : 'Junior', ('salary') : '5000000', ('work_duration') : '1']))
